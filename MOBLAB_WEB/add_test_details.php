                            ...
                            <footer class="panel-footer">
                                <div class="row">
                                    <div class="col-sm-9 col-sm-offset-3">
                                        ...
                                        <?php
                                            echo "<a href='assign_tester.php?tr_id=$req_id'><button type='button' class='btn btn-success'>Final submit</button></a>"
                                        ?>
                                    </div>
                                </div>
                            </footer>
...
if (isset($_POST['add_test_det']))
{
    ...
    $sel_testexist = "select * from assigned_test where testreq_id='$req_id' and test_id='$testsel'";
    if ($query = mysqli_num_rows(mysqli_query($conn,$sel_testexist)) > 0)
    {
        echo "<script>alert('Test already added for this request')</script>";
    }
    else
    {

...
<head>
    ...
    <title>Edit Subtest | MOBLAB</title>
                ...
                <div class="col-lg-12">
                    <section class="panel">
                        <header class="panel-heading">
                            ...
                            <h2 class="panel-title">Edit Subtest</h2>
                        </header>
                            ...
                            <div class="panel-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        $sel_stests = "select test_id, sub_name, ref_range from subtests where sub_id=$st_id";
                                        $resu = $conn ->query($sel_stests);
                                        ?>

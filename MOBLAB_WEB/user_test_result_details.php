...
if (isTheseParametersAvailable(array('user_id','test_date','doc_name')))
{
    ...
    $temp = array();
    $results = array();
    $asgn_sel = "select ass_id, test_id from assigned_test where testreq_id=(select tr_id from test_request where doc_name='$doc_name' and user_id='$user_id' and tr_date='$tr_date' and status=5)";
